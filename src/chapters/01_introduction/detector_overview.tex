...
\begin{figure}[!htbp]
  ...
  \caption{Schematic ATAR stack concept. Alternating strip orientations provide
  three-dimensional position information for pion stops, short muon segments,
  and outgoing positrons while keeping inactive material low.}
